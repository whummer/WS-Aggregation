...
public final class BufferItem {
	...
	public SeqFIFOStore owningStore;
	...
	/** added by hummer@dsg.tuwien.ac.at */ 
	public int getBufferNodeCount() {
		return content.getMaxNodeId();
	}
	...
	public TokenInterface get(int tokenId,int endNode) {		
	    //System.out.println("FI"+endNode+" "+firstItemId);
