...
package at.ac.tuwien.infosys.monitoring.events.stock;
...
//private static final Logger LOGGER = Util.getLogger(StockMonitoringTest.class);
//	
...
//		final String fileContent = UTIL.readFile(StockMonitoringTest.class.getResourceAsStream("monitoringTest.xml"));
