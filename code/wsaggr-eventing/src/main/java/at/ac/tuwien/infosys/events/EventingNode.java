...
public class EventingNode extends AbstractNode {

	private static final Logger LOGGER = Util.getLogger(EventingNode.class);
	...
	public void sendEvent(Event event) throws Exception {
		...
		WebServiceClientUtil.execute(getEPR(), wsEvent, null);
	}
