...
public class TestSetupSimple {
	...
	public void doTestSetup() throws Exception {
		...
		BurstServiceStarter.startAggregator(Configuration
				.getHost(Configuration.PROP_HOST), Configuration.getHost(
				Configuration.PROP_BINDHOST, Configuration.PROP_HOST), 9701);
	...
	public static void main(String[] args) throws Exception {
		new TestSetupSimple().doTestSetup();
