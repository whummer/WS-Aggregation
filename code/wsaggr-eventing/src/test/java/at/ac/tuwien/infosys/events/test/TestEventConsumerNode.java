...
@org.junit.Ignore
public class TestEventConsumerNode extends EventConsumerNode {

	private EventTypeRepository eventTypeRep;
	
	private static final Logger LOGGER = Util.getLogger(TestEventConsumerNode.class);
	
	private static Util UTIL = new Util();
	
	public TestEventConsumerNode(EndpointReference epr, EventTypeRepository eventTypeRep) {
		super(epr);
